<?php
  ...
  //④掛け合わせた数字の結果によっておみくじを選び、変数に入れます
    ...
    function fortune($fortuneNumber) {
      [09-Oct-2023 19:50:22 Asia/Tokyo] PHP Notice:  Undefined variable: password in /Applications/MAMP/htdocs/LetsEngineer/curriculum/PHPjob/curriculum/5-2/signUp.php on line 19
        if ($fortuneNumber >= 37) {
            $fortune = "残念";
